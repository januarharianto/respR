...
capture.output({  ## stops printing outputs on assigning
  ...
  test_that("convert_DO output conversions, using %Air, have expected results", {
    ...
    expect_equal(round(convert_DO(10, "%Air", "%O2", S = 35, t = 25, P = 1.013253)$output, 3), 2.095)
  ...
  test_that("convert_DO produces the correct numeric output", {
    ...
    expect_is(convert_DO(10, "%O2", "mg/l", S = 35, t = 25, P = 1.013253)$output, "numeric")
  ...
  test_that("convert_DO S3 generics work", {
    ...
    ob <- convert_DO(10, "inHg", "mg/l", S = 35, t = 25, P = 1.013253)
    ob_many <- convert_DO(10:30, "inHg", "mg/l", S = 35, t = 25, P = 1.013253)
