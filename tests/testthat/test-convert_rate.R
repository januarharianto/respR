...
expect_equal(suppressWarnings(convert_rate(10, volume = 1, mass = 1, S = 35, t = 25)$output), 36000)
...
# specific warnings
expect_warning(convert_rate(10, volume = 1, mass = 1, S = 35, t = 25), 
               "o2.unit` is not provided, using `mg/L`.")
expect_warning(convert_rate(10, volume = 1, mass = 1, S = 35, t = 25), 
               "'time.unit' is not provided, using 's'.")
expect_warning(convert_rate(10, volume = 1, mass = 1, S = 35, t = 25), 
               "'output.unit' is not provided, using 'mg/h/kg`.")
  
expect_warning(convert_rate(10, o2.unit = "mg/l", volume = 1, mass = 1, S = 35, t = 25))
expect_warning(convert_rate(10, time.unit = "s", volume = 1, mass = 1, S = 35, t = 25))
