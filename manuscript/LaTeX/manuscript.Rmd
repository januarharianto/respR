...
4. Although designed specifically with aquatic respirometry in mind, the object-oriented approach of the package and the dimensionless nature of its analytical functions mean that parts of the package can easily be used to estimate any other linear relationships in other research disciplines."
