...
The function `calc_rate_ft()` is used to specifically analyse flow-through respirometry data, and is similar to `calc_rate()` in functionality. However it accepts additional inputs of incurrent and excurrent oxygen concentration, and flow rate.`calc_rate_ft()` can process data to determine the mean or modal $RO_2$ over a period.
