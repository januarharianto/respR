...
#' of criteria. It can subset data based on ranges of: time, oxygen, row number,
#' or proportion of total oxygen used or produced (note, this last option works
...
#' and oxygen in the second column. For `inspect()` objects, the data will have
#' been coerced to this structure already. The function can subset **any** data
#' frame by `row`.
#'
