...
#' @examples
#' checkUnit('min', 1)
#' checkUnit('notatunit', 1)
#'
#' checkUnit('hpa', 2)
#' checkUnit('notatunit', 2)
checkUnit <- function(unit, type) {
  if (type == 1) {
    allUnits <- list(
      hour = c('hour', 'hr', 'h'),
      min  = c('minute', 'min', 'm'),
  ...
  if(type == 2) {
    allUnits <- list(
      ...
      'ug/L'    = c('ug/L', 'ug/l', 'ugL-1', 'ugl-1', 'ug per liter', 'ug per litre', 'µg/L', 'µg/l', 'µgL-1', 'µgl-1', 'µg per liter', 'µg per litre'),
      'mmol/L'  = c('mmol/L', 'mmol/l', 'mmolL-1,', 'mmoll-1', 'mmol per liter', 'mmol per litre'),
      'umol/L'  = c('umol/L', 'umol/l', 'umolL-1', 'umoll-1', 'µmol/L', 'µmol/l', 'µmolL-1', 'µmoll-1', 'umol per litre', 'umol per liter', 'µmol per litre', 'µmol per liter'),
      'mL/L'    = c('ml/L', 'mL/L', 'ml/l', 'mll-1', 'mLl-1', 'mLL-1', 'mlL-1', 'ml per l', 'mL per L', 'ml per L'),
      'mg/L'    = c('mg/L', 'mg/l', 'mgL-1', 'mgl-1', 'mg per litre', 'mg per liter'),
      ...
      'mmol/kg' = c('mmol/kg', 'mmol/Kg', 'mmolkg-1', 'mmolKg-1', 'mmol per kg', 'mmol per Kg'),
      'umol/kg' = c('umol/kg', 'umol/Kg', 'umolkg-1,', 'umolKg-1', 'umol per kg', 'umol per Kg', 'µmol/kg', 'µmol/Kg', 'µmolkg-1,', 'µmolKg-1', 'µmol per kg', 'µmol per Kg'),
      'Torr'    = c('torr', 'TORR', 'Torr', 'Tor', 'tor'),
      'hPa'     = c('hPa', 'hpa', 'Hpa', 'HPA', 'HPa', 'hectopascal', 'hpascal'),
      'kPa'     = c('kPa', 'kpa', 'Kpa', 'KPA', 'KPa', 'kilopascal', 'kpascal'),
      'mmHg'    = c('mmHg', 'mm Hg', 'mmhg', 'mm hg', 'MMHG', 'MM HG', 'millimeter of mercury', 'mm mercury'),
      'inHg'    = c('inHg', 'in Hg', 'inhg', 'in hg', 'INHG', 'IN HG', 'inch of mercury', 'inch mercury'))
  }
  if(type == 3) {
    allUnits <- list(
      uL = c('ul', 'uL'),
