...
```{r eval = T, results = "hide", fig.keep="none", message=FALSE, warning=FALSE}
## Load the package
library(respR)

## Import data
## Here we would typically use read.csv() to import an data file, but sardine.rd is already loaded
...
exp_1 <- inspect_data(sardine.rd)

## Determine rates
exp_1_best_rate <- auto_rate(exp_1)
...
exp_1_best_rate_conv <- convert_rate(exp_1_best_rate, 
                                output.unit = "mg/h/kg",
...
## Inspect
urch_data <- inspect_data(urchins.rd, time = 1, oxygen = 15)
