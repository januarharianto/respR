...
A full example is avalable at the end of this document.
...
- go through the regression method briefly (including equation? it will be slightly different from current papers... so maybe a good idea to mark that out)
- emphasise weighted average method when doing multitle subsets of data (include equation?)
- mention the typical workflow (maybe also use a flowchart)
...
7. `smooth.data` performs a rolling average over a dataset to produce "smoother" data for analysis. NOT DONE
