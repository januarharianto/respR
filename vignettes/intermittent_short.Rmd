...
Only the first rate converted rate is shown in the `print` output, but all rates within the object are converted. They can be viewed via `summary`. This shows a condensed version of the object `$summary` table. 
