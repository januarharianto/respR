...
Notice that we get identical critical values as the analysis on `oxygen~time` data [above](#bsr), despite the very different rate values (y-axis) and the fact these are *mass-specific* rates.
