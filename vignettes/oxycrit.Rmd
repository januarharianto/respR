...
```{r, fig.alt = "inspect() output for squid respirometry data showing oxygen timeseries and rolling rate"}
...
```{r, echo = FALSE, fig.alt = "oxy_crit broken-stick regression result showing critical oxygen value on timeseries and rate vs oxygen plots"}
print(squid.bsr)
...
```{r message=FALSE, results='hide', fig.height=3, fig.alt = c("Broken-stick result with width 0.05 showing rate vs oxygen", "Broken-stick result with width 0.2 showing rate vs oxygen")}
...
```{r, echo = FALSE, fig.alt = "oxy_crit segmented regression result showing critical oxygen value on timeseries and rate vs oxygen plots"}
print(squid.seg)
...
```{r message=FALSE, results='hide', fig.height=3, fig.alt = c("Segmented result with width 0.05 showing rate vs oxygen", "Segmented result with width 0.2 showing rate vs oxygen")}
...
```{r, fig.alt = "oxy_crit result from pre-calculated rate vs oxygen data showing critical oxygen value"}
