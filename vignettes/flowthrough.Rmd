...
This is just an example. Other results and columns in `$summary` can be used in a similar way to filter results, for instance to extract maximum or minimum rate values, or only those within a specific value range.
