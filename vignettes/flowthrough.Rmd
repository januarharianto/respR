...
convert_rate(chiton.ft.rate.sub$mean, o2.unit = "mg/l", time.unit = "s", output.unit = "mg/h", volume = 1)
convert_rate(chiton.ft.rate.sub$mean, o2.unit = "mg/l", time.unit = "s", output.unit = "mg/h/g", volume = 1, mass = 0.000070)
```
