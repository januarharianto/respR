...
```{r, fig.alt = "Plot of sardine.rd respirometry data subsampled to 100 evenly-spaced rows"}
...
```{r, fig.alt = "Plot of sardine.rd oxygen vector subsampled to 500 evenly-spaced data points"}
