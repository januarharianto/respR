---
title: "import_file: Importing your data"
output: 
  rmarkdown::html_vignette:
    toc: true
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{import_file: Importing your data}
...
If you can't import teh data via `import_file`, consider trying the following functions, which are the ones we use internally:
