...
Determine critical oxygen values, for example PCrit, from long-term, closed chamber respirometry experiments.

**[Adjusting rates for background](https://januarharianto.github.io/respR/articles/pcrit.html)**  
How `adjust_rate` allows you to perform all sorts of different adjustments to rates to account dor the metabolic action of microbial organisms. 
