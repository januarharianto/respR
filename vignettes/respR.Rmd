...
*Flow-through* respirometry involves a closed chamber, but with a regulated flow of air or water through it at a precisely determined rate. After equilibrium has been achieved, the oxygen concentration differential between the incurrent and excurrent channels, along with the flow rate, allows calculation of the oxygen extracted from the flow volume per unit time: $$\dot{V}O_2 = (C_iO_2 - C_eO_2)FR$$ where $\dot{V}O_2$ is the rate of $O_2$ consumption over time, $C_iO_2$ and $C_eO_2$ are the incurrent and excurrent $O_2$ concentrations, and $FR$ is the flow rate of water through the system (Lighton 2008).

A final method is *open-tank* respirometry, in which an open tank or semi-enclosed area is used, but the input or mixing rate of oxygen from the surroundings has been quantified or found to be negligible relative to oxygen consumption of the specimens (Leclercq et al., 1999). It is seldom used, but for some applications it is a sufficient and practical methodology (Gamble et al. 2014). The common equation used for open respirometry is: $$\dot{V}O_2 = \dot O_2V + \phi_d$$ where $\dot O_2V$ is the slope of the regression that relates $O_2$ concentration to time, $V$ is the volume of the container and $\phi_d$ is the oxygen flux as determined by Fick's Law (Leclercq et al., 1999).
...
**[Importing your data](https://januarharianto.github.io/respR/articles/importing.html)** `respR` has functions to make it easy to bring in and prepare your data, even from the raw data files output by various respirometry systems.

**[Quick-start using closed-chamber respirometry](https://januarharianto.github.io/respR/articles/closed.html)** This is a good place to start exploring the full functionality of `respR`. It describes an entire workflow to process and analyse a closed-chamber respirometry dataset.

**[Automatic detection of metabolic rates](https://januarharianto.github.io/respR/articles/auto_rate.html)** Here we introduce the function `auto_rate()` for the automatic detection and estimation of common metrics.

**[Performance of auto_rate in detecting linear regions](https://januarharianto.github.io/respR/articles/performance.html)** We use simulated data to test the accuracy of `auto_rate()`, and discuss the function's performance with focus on linear data detection.

**[Comparative performance of auto_rate and LoLinR](https://januarharianto.github.io/respR/articles/auto_rate_comp.html)** We make comparisons to another R package, LoLinR, using data from their package and simulated data. 

**[Intermittent-flow respirometry: Simple example](https://januarharianto.github.io/respR/articles/intermittent.html)**  
...
**[Flowthrough respirometry](https://januarharianto.github.io/respR/articles/flowthrough.html)** Analysis of flowthrough respirometry data.

**[PCrit](https://januarharianto.github.io/respR/articles/pcrit.html)** Determine P~crit~ in long-term, closed chamber respirometry experiments.

**[Two-point analyses](https://januarharianto.github.io/respR/articles/twopoint.html)**  
Determine oxygen use rate using only two datapoints.

**[Reproducibility](https://januarharianto.github.io/respR/articles/reproducibility.html)** How `respR` has been designed to allow reporting of reproducible analyses.

**[respR and the Tidyverse](https://januarharianto.github.io/respR/articles/tidyverse.html)** Information about how `respR` integrates with `tidyverse` practices to streamline analytic workflows.

**[A comparison of respR with other R packages](https://januarharianto.github.io/respR/articles/packages_comp.html)**  
