...
vignette: >
  %\VignetteIndexEntry{respR Workflow}
...
The output also includes a `rate_2pt` output. This is the rate determined by simple two-point calculation of difference in O~2~ divided by difference in Time, and can be useful in determining rate where only a limited number of data points are available, such as in 'closed bottle' respirometry. 
