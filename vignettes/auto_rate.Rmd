...
<!-- By default, `auto_rate()` uses a rolling window of 0.2 multiplied by the total length of the number of data samples, or total time elapsed. This can be adjusted using the `width` argument as a proportion (`width = 0.1`) or a fixed number (`width = 2000`). -->
