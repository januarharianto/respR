...
```{r fig.alt = "Four-panel plot of calc_rate results across the entire sardine dataset showing the time series with fitted region highlighted, the close-up of the fitted region with the linear regression, and the residual and Q-Q diagnostic plots."}
cr <- calc_rate(sard)
```
...
```{r fig.alt = "Four-panel plot of calc_rate results for the time range 20 to 80 minutes showing the full time series with the selected region highlighted, the close-up with linear regression, and residual and Q-Q diagnostic plots."}
cr <- calc_rate(sard,
                from = 20,
                to = 80,
                by = "time")
...
```{r fig.alt = "Four-panel plot of calc_rate results for the row range 2000 to 6000 showing the full time series with the selected region highlighted, the close-up with linear regression, and residual and Q-Q diagnostic plots."}
cr <- calc_rate(sard,
                from = 2000,
                to = 6000,
                by = "row")
...
```{r fig.alt = "Four-panel plot of calc_rate results for the oxygen range 94 to 92 percent air saturation showing the full time series with the selected region highlighted, the close-up with linear regression, and residual and Q-Q diagnostic plots."}
cr <- calc_rate(sard,
                from = 94,
                to = 92,
                by = "oxygen")
...
```{r fig.alt = "Four-panel plot of calc_rate results showing the first of seven sequential time-window rates with the full time series, the close-up of the fitted region with linear regression, and residual and Q-Q diagnostic plots."}
cr <- calc_rate(sard,
...
```{r fig.alt = "Single-panel close-up plot of calc_rate result 2 showing the oxygen time series subset with the linear regression fit, with rotated axis labels and no legend."}
