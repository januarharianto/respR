...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "Comparison of convert_DO (respR) and conv_o2 (respirometry) outputs"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "Comparison of rMR and respR data import code"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "Comparison of rMR and respR imported data frames"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "rMR MR.loops rate calculation code"}
knitr::include_graphics("img/pkg_comp/pkg_comp04.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "rMR MR.loops plot output showing regression fits"}
knitr::include_graphics("img/pkg_comp/pkg_comp05.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "respR calc_rate code and output for same data regions"}
knitr::include_graphics("img/pkg_comp/pkg_comp06.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "Comparison of rMR and respR rate results"}
knitr::include_graphics("img/pkg_comp/pkg_comp07.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "respR calc_rate plot output showing regression fits"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "FishResp import.meas code for importing AutoResp data"}
knitr::include_graphics("img/pkg_comp/pkg_comp09.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "FishResp imported data plot showing oxygen over time"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "FishResp analysis workflow code and output"}
...
```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "respR analysis workflow code for same FishResp data"}
knitr::include_graphics("img/pkg_comp/pkg_comp12.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "respR calc_rate plot output for FishResp comparison data"}
knitr::include_graphics("img/pkg_comp/pkg_comp13.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "Comparison of FishResp and respR rate results"}
knitr::include_graphics("img/pkg_comp/pkg_comp14.png")
```

```{r, out.width = "700px", eval = T, echo = FALSE, fig.cap = "respR convert_rate output for FishResp comparison data"}
