...
Here we will show a simple `for` loop to subset each replicate from the `zeb_intermittent.rd` data from the second replicate onwards. We then run `auto_rate(method = "linear")` on it. We use a 'wait' period of 2 minutes (120s), and a 'measure' period of 7 minutes (420s), leaving 2 minutes of flushing excluded.
