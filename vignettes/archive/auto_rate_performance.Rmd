...
```{r, echo = F, fig.cap = "25 randomly generated default-type simulated datasets"}
...
```{r, echo = F, fig.cap = "25 randomly generated corrupted-type simulated datasets"}
...
```{r, echo = F, fig.cap = "25 randomly generated segmented-type simulated datasets"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on default-type data with 100 samples"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on default-type data with 500 samples"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on corrupted-type data with 100 samples"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on corrupted-type data with 500 samples"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on segmented-type data with 100 samples"}
...
```{r, echo = F, fig.cap = "Performance metrics for auto_rate on segmented-type data with 500 samples"}
