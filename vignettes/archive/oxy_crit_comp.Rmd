...
```{r, echo = F, fig.cap = "rMR PCrit analysis code output"}
knitr::include_graphics("img/oxy_crit_comp/oxy_crit_comp_01.png")
```

```{r, echo = F, fig.cap = "rMR PCrit analysis plot output"}
...
```{r, echo = F, fig.cap = "respR oxy_crit analysis console output"}
knitr::include_graphics("img/oxy_crit_comp/oxy_crit_comp_03.png")
```

```{r, echo = F, fig.cap = "respR oxy_crit analysis plot output"}
