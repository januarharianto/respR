...
- A function or workflow to automatically identify replicates, run `calc_rate` or `auto_rate` on each one, then summarise the result. 
- See [here](https://github.com/januarharianto/respR/issues/131) and feel free to make suggestions.
