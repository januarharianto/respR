...
We can see the background rate increases by around 70% over the course of the experiment. We will use these later in [Adjusting rates](#adjust) to apply a dynamic background adjustment to rates based on their time during the experiment.
...
zeb_mmr_conv <- convert_rate(zeb_mmr_adj,
                             oxy.unit = "mg/L",       # oxygen units of the original data
