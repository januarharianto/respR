...
We can see from the top plot that this dataset has three replicates. The flush periods obviously skew the bottom plot which shows rate of change in O~2~ concentration, however uptake rates (flat regions) appear to be consistent within each experimental replicate. 
