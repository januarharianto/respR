...
### Converting rates
Once the rates have been determined, they can be converted to volume-corrected or mass-specific rates using `convert_rate`. The `print()` call will list up to 6 regressions and the weighted mean of the results are also given.
