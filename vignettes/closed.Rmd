...
We can see our rate is consistent with these others from the literature, and any difference is easily within what we might expect given differences between species and temperature. Generally speaking, if there is a order of magnitude difference or more it is a good indication that something has gone wrong. Therefore, here we can be fairly confident we have not made a major conversion error somewhere, and we have found that our rates are in the right ballpark.
