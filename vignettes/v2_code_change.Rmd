...
The `"%"` oxygen unit has been deprecated and replaced with `"%Air"`. In older code replace `"%"` (and other variations such as `"percent"`) with `"%Air"`. See `help("convert_DO")`. Note, the the additional unit of `"%O2"` has been added. These are not the same. 
