...
The [FishResp](https://fishresp.org) package has recently come out of beta with the release of version 1.0. A guide to usage of the package is also now available on [bioRxiv](https://www.biorxiv.org/content/10.1101/467845v1) and soon to be published in *Conservation Physiology*. 
...
knitr::include_graphics("https://raw.githubusercontent.com/januarharianto/respR/develop/vignettes/img/anch_fishresp.png")
```
